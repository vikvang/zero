...
import (
	...
	"github.com/vikvang/zero/internal/llm/prompt"
	...
	"github.com/vikvang/zero/internal/tui/components/logo"
	lspcomponent "github.com/vikvang/zero/internal/tui/components/lsp"
	"github.com/vikvang/zero/internal/tui/components/mcp"
	"github.com/vikvang/zero/internal/tui/exp/list"
...
func (s *splashCmp) View() string {
	...
	if s.needsAPIKey {
		...
		initText := lipgloss.JoinVertical(
			...
			bodyStyle.Render("result into a ZERO.md file which serves as general context."),
			"",
